...
require("lazy").setup({
...

  {
    ...
    opts = {},
    -- ideas:
    -- <leader>tj: toggle bottom
    -- <leader>tl: toggle right
    -- <leader>tf: toggle floating
    -- <leader>toj: toggle bottom (with pwd of file of open buffer)
    -- <leader>tol: toggle right (with pwd of file of open buffer)
    -- <leader>tof: toggle floating (with pwd of file of open buffer)
  },
